...
# 2. 
SPARK_REMOTE="sc://adb-5854717212043428.8.azuredatabricks.net:443/;token=dapi5a8aaeea1ec89e7252542757476b9f5c;x-databricks-cluster-id=<cluster id>"

# 3.
spark = DatabricksSession.builder.remote(
    host="adb-5854717212043428.8.azuredatabricks.net",
    cluster_id="0324-195708-nlv2jrsc",
    token="dapi5a8aaeea1ec89e7252542757476b9f5c"
).getOrCreate()
